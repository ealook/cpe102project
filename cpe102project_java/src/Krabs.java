...
public class Krabs extends WorldEntity {
    ...
    public Krabs(String name, Point position, int resource_limit, int rate, ArrayList<PImage> imgs) {
    ...
    public String entity_string() {
        return "krabs" + " " + this.getName() + " " + this.getPosition().getX()
